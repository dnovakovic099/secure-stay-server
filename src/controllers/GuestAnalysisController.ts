...
export class GuestAnalysisController {
    ...
    private buildRecordFilters(req: Request): GuestAnalysisRecordFilters {
        ...
        return {
            ...
            propertyType: parseList(req.query.propertyType),
            serviceType: parseList(req.query.serviceType),
            dateType: req.query.dateType === "departureDate" ? "departureDate" : req.query.dateType === "arrivalDate" ? "arrivalDate" : undefined,
