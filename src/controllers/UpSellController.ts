...
export class UpSellController {
  ...
  async updateMultipleSellStatus(request: Request, response: Response) {
    ...
    const data = await updateUpSellStatus.updateMultipleSellStatus(
      request,
      response
    );
    return response.send(data);
  ...
  async deleteMultipleUpSell(request: Request, response: Response) {
    ...
    const data = await multipleDeleteUpSellServices.deleteMultipleUpSells(
      request,
      response
    );
    return response.send(data);
  ...
  async getAssociatedUpSellListing(request: Request, response: Response) {
    ...
    const upSellListing = await getUpSellListing.getUpSellAssociatedListing(
      request,
      response
    );
  ...
  async getPropertyConfigHistory(request: Request, response: Response) {
    const getUpSellHistory = new UpSellServices();
