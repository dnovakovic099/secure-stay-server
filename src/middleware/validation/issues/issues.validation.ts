...
export const validateGetIssues = (request: Request, response: Response, next: NextFunction) => {
    const schema = Joi.object({
        ...
        dateType: Joi.string().valid('created', 'updated', 'last_updated', 'activity_updated', 'completed', 'due', 'check_in', 'check_out').optional(),
        ...
        activityType: Joi.string().valid('all', 'created', 'updated', 'last_updated', 'completed').optional(),
