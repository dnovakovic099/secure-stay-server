...
export const validateGetReviewRequest = (request: Request, response: Response, next: NextFunction) => {
    ...
    const schema = Joi.object({
        ...
        status: arrayOrSingle(Joi.string().valid("active", "hidden", "Awaiting Review", "Submitted", "Visible", "No Review", "Remove/Keep?", "Keep", "To be Removed", "Removing", "Removed", "Remove Failed", "Archived").required()).allow(null, ""),
...
export const validateUpdateReviewVisibilityStatusRequest = (request: Request, response: Response, next: NextFunction) => {
    const schema = Joi.object({
        reviewVisibility: Joi.string().required().valid("Awaiting Review", "Submitted", "Visible", "No Review", "Remove/Keep?", "Keep", "To be Removed", "Removing", "Removed", "Remove Failed", "Archived"),
    });
