...
router.patch(
    "/conversations/:threadId/internal-note/:messageId/pin",
    verifySession,
    inboxV2Controller.setInternalNotePinned
);
...
router.post("/conversations/:threadId/ai/ask", verifySession, inboxV2Controller.aiAsk);
