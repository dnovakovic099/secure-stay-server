...
router.route('/listing/:listingId/contacts').get(verifySession, clientController.getListingClientContacts.bind(clientController));
...
router.route('/client-facing/acknowledgement').put(verifySession, validateUpdateAcknowledgement, clientController.updateAcknowledgement.bind(clientController));
