...
router.route('/update').put(verifySession, contextMiddleware, validateUpdateClient, clientController.updateClient.bind(clientController));
router.route('/').get(verifySession, validateGetClients, clientController.getClients.bind(clientController));
router.route('/:id').delete(verifySession, contextMiddleware, clientController.deleteClient.bind(clientController));
...
router.route('/sales/pre-onboarding').put(verifySession, contextMiddleware, validateUpdatePropertyOnboarding, clientController.updatePropertyPreOnboardingInfo.bind(clientController));
...
router.route('/internal/onboarding').put(verifySession, contextMiddleware, validateUpdateOnboardingDetails, clientController.updatedOnboardingDetails.bind(clientController));
...
router.route('/internal/service-info').put(verifySession, contextMiddleware, validateUpdateServiceInfo, clientController.updateServiceInfo.bind(clientController));
...
router.route('/internal/management').put(verifySession, contextMiddleware, validateUpdateManagementInternalForm, clientController.updateManagementInternalForm.bind(clientController));
router.route('/internal/listing-info').put(verifySession, contextMiddleware, validateUpdateListingInfo, clientController.updateListingInfo.bind(clientController));

router.route('/internal/finacials').put(verifySession, contextMiddleware, validateUpdateFinancialsInternalForm, clientController.updateFinancialsInternalForm.bind(clientController));
...
router.route('/client-facing/onboarding').put(verifySession, contextMiddleware, validateUpdateOnboardingDetailsClientForm, clientController.updateOnboardingDetailsClientForm.bind(clientController));
...
router.route('/client-facing/listing-info').put(verifySession, contextMiddleware, validateUpdateListingDetailsClientForm, clientController.updateListingDetailsClientForm.bind(clientController));


router.route('/get-client-details/:id').get(verifySession, clientController.getClientDetails.bind(clientController));

router.route('/publish-property/:propertyId').get(verifySession, contextMiddleware, clientController.publishPropertyToHostaway.bind(clientController));
