...
const PUBLIC_URL = `${process.env.BASE_URL}/assets`;
...
export const BADGE_RIGHT_TOP = `${PUBLIC_URL}/badge-right-top.png`;
export const BADGE_LEFT_BOTTOM = `${PUBLIC_URL}/badge-left-bottom.png`;
