...
export class InboxAIAuditService {
    ...
    async judgeRelevance(rows: AIMessageSuggestionEntity[]): Promise<number> {
        ...
        const system = [
            ...
            "  * wrong info: the AI stated something factually contradicted by the team reply (price, rule, amenity, address, code, availability) — only for stable facts, not one-off internal statuses the AI could not know.",
