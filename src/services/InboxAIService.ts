...
export class InboxAIService {
    ...
    private systemPrompt(
        ...
        return [
            ...
            "- DISCRETIONARY REQUESTS — early check-in / late check-out / pool heating / parking follow Available paid services from the Upsells page (rate configuration + charge type already baked into the guest fee). SDTO = Same Day Turnover: NOT ALLOWED + same-day turnover → auto-decline with the cleaner turnover-window explanation and no fee; NOT ALLOWED with no same-day turnover → quote fee; NEEDS CONFIRMATION or blank → quote the calculated fee subject to availability and ask whether the guest wants the team to confirm (today requests are declined for now, but offer to double-check); ALLOWED → quote the calculated fee subject to availability and ask whether they want to proceed so the team can confirm and send the payment link. Do not approve a specific clock time unless a TEAM message already confirmed it. Extensions beyond listed nights, group-size changes, and fee waivers remain team-decided — always escalate those.",
            ...
            "- SDTO: NOT ALLOWED + same-day turnover → decline with the applicable cleaner turnover-window explanation and no fee. NOT ALLOWED without same-day turnover → quote the fee. NEEDS CONFIRMATION or blank → quote the fee subject to availability and ask if the guest wants the team to confirm; for today's check-in/out, decline for now but offer to double-check. ALLOWED → quote the fee subject to availability and ask if they want to proceed so the team can confirm and send the payment link.",
